...
urlpatterns = [
    ...
    path('store/', checkoutview.productlist, name='productlist'),
    path('store/list/', checkoutview.productlist, name='productlist'),
    path('store/<slug:categoryslug>/', checkoutview.productlist, name='bycategory'),
    path('<path:rest_of_path>/', auth_views.LoginView.as_view(template_name='checkin/smalllogin.html')),
]