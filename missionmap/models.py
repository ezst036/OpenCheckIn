...
class MapPointPrefs(models.Model):
    ...
    mainCampusPointColor = models.CharField(verbose_name="Home church color", max_length=24, choices=missionColor, default='green')
    mainCampusIcon = models.CharField(verbose_name="Home church icon", max_length=40, default='fa-bars', blank=True)
    mainCampusIconColor = models.CharField(verbose_name="Home church color", max_length=24, choices=missionColor, default='white')
    secondaryCampusPointColor = models.CharField(verbose_name="Campus color", max_length=24, choices=missionColor, default='lightgreen')
    secondaryCampusIcon = models.CharField(verbose_name="Campus icon", max_length=40, default='fa-bars', blank=True)
    secondaryCampusIconColor = models.CharField(verbose_name="Campus color", max_length=24, choices=missionColor, default='white')